...
class OpenOverlayText extends _elementBase {
    ...
    connectedCallback() {
        ...
        // styles will be overridden by the _elementBase super class
        ...
        makeProperty(this, "fontSize", null,
            () => this._fontSize,
            (value) => { this._fontSize = value; this.style.fontSize = value + "px" });
        ...
        makeProperty(this, "letterSpacing", null,
            () => this._letterSpacing,
            (value) => { this._letterSpacing = value; this.style.letterSpacing = value + "px" });

        makeProperty(this, "lineHeight", null,
            () => this._lineHeight,
            (value) => { this._lineHeight = value; this.style.lineHeight = value + "px" });

        makeProperty(this, "textShadow", null,
            () => this._textShadow,
            (value) => { this._textShadow = value; this.style.textShadow = value });

        makeProperty(this, "textStroke", null,
            () => this._textStroke,
            (value) => { this._textStroke = value; this.style.webkitTextStroke = value });
        ...
        makeProperty(this, "underline", null,
            () => this._underline,
            (value) => { this._underline = value; this.style.textDecoration = (value ? "underline" : "normal"); });
